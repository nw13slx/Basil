...
int main(int argc, char **argv){
    ...
    while (In1.good()){
        ...
        pch= NULL;
        if (column == 3 ){
            if (( strcmp(content[0],"INITIAL") == 0 ) && (strcmp(content[1],"GUESS") == 0)&&(strcmp(content[2],"ORBITALS")==0)){
                Print_MO=true;
                break;
            }
        }
    ...
    if ((! In1.good()) || (Print_MO==false)){
        cout<<"ERROR: INITIAL GUESS ORBITALS block not found"<<endl;
        cout<<"please write below lines to your orca input script "<<endl;
        cout<<"\%output"<<endl;
        cout<<"Print[ P_GuessOrb ] 2"<<endl;
        cout<<"end"<<endl;
        return 1;
    }
    ...
    for (int spin=0;spin<2;spin++){
      ...
      do{
        ...
        if (column!=0){
            ...
            } else if ((energy_line ==0)  && (contain_digit(content[0])==true) && (contain_alphabet(content[0])==true)){
